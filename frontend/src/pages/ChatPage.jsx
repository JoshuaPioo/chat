    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <div className="relative w-full max-w-[1600px] md:h-[850px] h-[700px]">
        <BorderAnimatedContainer>
          <div className="w-full h-full flex flex-row bg-slate-900/60 backdrop-blur-xl rounded-2xl overflow-hidden border border-slate-800/70 shadow-[0_0_60px_-10px_rgba(56,189,248,0.5)]">

            {/* LEFT SIDEBAR - Chats List */}
            <div className="w-[380px] flex flex-col bg-slate-900/80 border-r border-slate-800/70">
            ...
            <div className="flex-1 flex flex-col bg-gradient-to-br from-slate-950/80 to-slate-900/80 backdrop-blur-md relative">
              {selectedUser ? (
                <div className="flex-1 flex flex-col">
                  <div className="h-16 border-b border-slate-800/70 flex items-center justify-between px-6 bg-slate-900/70 backdrop-blur-sm">
                    <h2 className="text-lg font-semibold text-cyan-400">{selectedUser.fullname}</h2>
